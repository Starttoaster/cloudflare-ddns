...
echo "This script is now set up as a personalized Cloudflare A Record updater for this domain. Run this script a second time to update your A Records (or schedule this to run as a crontab task)"
